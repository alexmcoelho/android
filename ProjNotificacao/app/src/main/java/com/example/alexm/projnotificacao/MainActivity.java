...
public class MainActivity extends AppCompatActivity {
    ...
    private View.OnClickListener criarNotificacaoSimples() {
        return new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NotificationUtil.criarNotificacaoSimples(
                        MainActivity.this, etMensagem.getText().toString(), NOTIFICACAO_SIMPLES);
            }
        };
    }
    ...
    private View.OnClickListener criarNotificacaoCompleto() {
        return new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                NotificationUtil.criarNotificacaoCompleto(
                        MainActivity.this, etMensagem.getText().toString(), NOTIFICACAO_COMPLETA);
            }
        };
    }
